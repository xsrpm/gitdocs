# 13) Cerrar Sesión, Enviar Correos (Restablecer contraseña), manejo de errores

0:00:00 CERRAR SESIÓN - Clase TokenController - revocarToken

07:30 - PRUEBAS CON REFRESH TOKEN

13:20 - RESTABLECIMIENTO DE CONTRASEÑA - olvidaste tu contraseña

- --PARTE BACKEND

- Elegir un correo electrónico que tenga permitido el acceso a terceros (Acceso de aplicaciones poco seguras - GMAIL)

- No tenga verificación en 2 pasos

Este sera el correo que enviará los mensajes (correo host)

22:14 - clase model ResetToken para reseteos de contraseña, clase repo, clase service, controller

31:00 - Clase EmailUtil, Clase Mail (DTO)

38:00 - Clase Login Controller, Clase Login Service, Clase Login Repo

- --PARTE FRONTEND

47:20 - Componente Recuperar, nueva función en service Login

55.30 - Abrir enlace de correo "Restablecer contraseña"

- Componente login/recuperar/token, función en Servicio Login, llamada a ws verificar token, verificar token en backend, verificar contraseñas diferentes

1:07:00 - Botón Cambiar contraseña. Servicio restablecer token, llamada a servicio

1:14:00 - GESTIONANDO ERRORES EN FRONTEND - HttpInterceptor, registrandolo en appmodule

1:25:00 - kahoot módulo 5 y 6
